...
import { PROPERTY_TYPES, PRICE_RANGES, AMENITIES as CATALOG_AMENITIES, AREA_RANGES } from "../constants/catalog";
...
export const PRICE_OPTIONS = [...PRICE_RANGES];
export const TYPE_OPTIONS = [...PROPERTY_TYPES];
export const AREA_OPTIONS = [...AREA_RANGES];
export const AMENITY_OPTIONS = [...CATALOG_AMENITIES].slice(0, 6); // 6 tiện ích chính cho filter bar
