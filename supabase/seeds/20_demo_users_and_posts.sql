...
insert into public.rental_listings (
  seller_id, title, property_type, price, district, area, status,
  approved_at, expire_at, address, description, contact_name, contact_phone,
  access_policy, access_close_time
)
select
  u.id, d.title, d.property_type, d.price, d.district, d.area, 'Active',
  now(), now() + interval '60 days', d.address, d.description,
  p.full_name, p.contact_phone, d.access_policy, d.close_time::time
from (values
  ('nguyen.van.a@tronhanh.demo', 'Phòng trọ mới xây, cửa sổ lớn, hẻm xe hơi', 'Phòng trọ', 1800000, 'Quận 12', 18, '45/7 Nguyễn Ảnh Thủ, Trung Mỹ Tây', 'Phòng vừa hoàn thiện tháng trước, tường sơn mới, cửa sổ hướng đông nên sáng cả buổi sáng. Hẻm 4m xe hơi vào tận nơi, khu này không ngập nước.', 'Free', null),
  ('nguyen.van.a@tronhanh.demo', 'Căn hộ mini có bếp riêng, gần chợ Hạnh Thông Tây', 'Căn hộ mini', 4500000, 'Gò Vấp', 32, '212 Quang Trung, Phường 10', 'Bếp và khu giặt tách hẳn khỏi phòng ngủ, có ban công phơi đồ. Đi bộ 5 phút ra chợ Hạnh Thông Tây, ngay trạm xe buýt số 24.', 'Free', null),
  ('nguyen.van.b@tronhanh.demo', 'Ký túc xá sinh viên 4 người/phòng, có máy giặt chung', 'Ký túc xá', 1200000, 'Thủ Đức', 28, '18 Đường số 6, Linh Trung', 'Giường tầng khung sắt chắc chắn, mỗi bạn một tủ khóa riêng. Khu vực chung có máy giặt và bàn học tự quản. Ưu tiên sinh viên năm nhất.', 'Restricted', '23:00'),
  ('nguyen.van.b@tronhanh.demo', 'Phòng trọ gác lửng, tách biệt chủ, giờ giấc tự do', 'Phòng trọ', 2600000, 'Thủ Đức', 22, '77/3 Võ Văn Ngân, Bình Thọ', 'Gác lửng đổ bê tông chịu lực, kê vừa nệm 1m6. Lối đi riêng không chung cửa với chủ nhà nên về khuya thoải mái.', 'Free', null),
  ('nguyen.van.c@tronhanh.demo', 'Căn hộ dịch vụ full nội thất, tòa nhà có thang máy', 'Căn hộ dịch vụ', 7500000, 'Quận 7', 42, '159 Nguyễn Thị Thập, Tân Phú', 'Nội thất còn mới: giường, tủ âm tường, sofa, bếp từ và máy giặt riêng trong phòng. Tòa nhà có thang máy, bảo vệ trực 24/7.', 'Free', null),
  ('nguyen.van.c@tronhanh.demo', 'Studio yên tĩnh trong khu dân cư Him Lam', 'Căn hộ mini', 5800000, 'Quận 7', 30, '23 Đường số 1, Him Lam', 'Nằm sâu trong khu dân cư nên rất yên, hầu như không nghe tiếng xe. Hợp với người làm việc tại nhà. Cửa sổ nhìn ra mảng xanh nội khu.', 'Free', null),
  ('nguyen.van.d@tronhanh.demo', 'Nhà nguyên căn 1 trệt 1 lầu, 2 phòng ngủ', 'Nhà nguyên căn', 9500000, 'Bình Thạnh', 60, '31/12 Xô Viết Nghệ Tĩnh, Phường 21', 'Tầng trệt là phòng khách và bếp, trên lầu có 2 phòng ngủ và sân phơi. Sân trước để được 3 xe máy. Hợp gia đình nhỏ hoặc nhóm bạn ở chung.', 'Free', null),
  ('nguyen.van.d@tronhanh.demo', 'Phòng trọ giá tốt cho người đi làm, gần Hàng Xanh', 'Phòng trọ', 1900000, 'Bình Thạnh', 16, '94/5 Đinh Bộ Lĩnh, Phường 26', 'Phòng gọn, đủ chỗ kê giường 1m4 và một bàn làm việc. Cách vòng xoay Hàng Xanh 700m nên vào trung tâm rất nhanh. Giá đã gồm phí rác và nước.', 'Free', null),
  ('nguyen.van.e@tronhanh.demo', 'Căn hộ mini WC riêng, nhận nuôi thú cưng', 'Căn hộ mini', 3800000, 'Quận 10', 26, '168 Tô Hiến Thành, Phường 15', 'Chủ nhà cũng nuôi mèo nên rất thoải mái chuyện thú cưng, chỉ cần giữ vệ sinh chung. WC riêng có bình nóng lạnh. Gần Vạn Hạnh Mall.', 'Free', null),
  ('nguyen.van.e@tronhanh.demo', 'Phòng master có ban công, view thoáng tầng cao', 'Phòng trọ', 4200000, 'Quận 10', 28, '45 Bà Hạt, Phường 9', 'Phòng lớn nhất tầng, ban công riêng đủ kê bàn cà phê. Ở tầng 4 nên thoáng và ít bụi. Có chỗ để xe máy trong nhà.', 'Free', null),
  ('nguyen.van.f@tronhanh.demo', 'Căn hộ dịch vụ 2 phòng ngủ, dọn phòng hàng tuần', 'Căn hộ dịch vụ', 12000000, 'Quận 7', 55, '1 Đường số 11, Tân Phong', 'Dịch vụ dọn phòng và thay ga giường mỗi tuần đã tính trong giá. Hai phòng ngủ đều có cửa sổ. Tòa nhà có hồ bơi và phòng gym dùng chung.', 'Free', null),
  ('nguyen.van.g@tronhanh.demo', 'Phòng trọ sạch sẽ, an ninh, có camera hành lang', 'Phòng trọ', 2300000, 'Gò Vấp', 20, '60/14 Lê Đức Thọ, Phường 16', 'Hành lang và cổng đều có camera, chủ nhà ở ngay tầng trệt. Dãy chỉ 8 phòng nên yên tĩnh, người thuê chủ yếu là nhân viên văn phòng.', 'Free', null),
  ('nguyen.van.h@tronhanh.demo', 'Nhà nguyên căn hẻm rộng, phù hợp nhóm ở ghép', 'Nhà nguyên căn', 8000000, 'Thủ Đức', 50, '5 Đường 12, Trường Thọ', 'Ba phòng ngủ nhỏ, chia vừa cho 3–4 bạn ở ghép. Bếp rộng, có sân sau phơi đồ. Hẻm rộng 5m, gần chợ Thủ Đức.', 'Free', null),
  ('nguyen.van.i@tronhanh.demo', 'Căn hộ mini gần ĐH Bách Khoa cơ sở 2', 'Căn hộ mini', 3500000, 'Thủ Đức', 24, '9 Đường số 3, Đông Hòa', 'Đi bộ 10 phút tới cổng trường. Phòng có gác để đồ, bếp nhỏ và máy lạnh mới lắp năm nay. Nhiều bạn Bách Khoa đang thuê cùng dãy.', 'Free', null),
  ('nguyen.van.j@tronhanh.demo', 'Ký túc xá nữ, quản lý chặt, đóng cửa 23h', 'Ký túc xá', 1500000, 'Quận 10', 30, '220 Lý Thường Kiệt, Phường 14', 'Chỉ nhận nữ, có quản lý ở cùng khu. Cổng đóng lúc 23h nên phụ huynh yên tâm. Bếp chung và khu giặt phơi riêng cho từng tầng.', 'Restricted', '23:00')
) as d(email, title, property_type, price, district, area, address, description,
...
insert into public.demand_posts (
  renter_id, kind, title, desired_districts, price_min, price_max, status,
...
select
  u.id, d.kind, d.title, d.districts, d.price_min, d.price_max, 'Active',
...
from (values
  ('tran.thi.a@tronhanh.demo', 'RoomWanted', 'Tìm phòng trọ có gác khu Thủ Đức, dọn vào đầu tháng sau', array['Thủ Đức', 'Quận 12']::text[], 1500000, 2500000, 'Mình là sinh viên năm 3, cần phòng có gác để tiết kiệm diện tích. Ở một mình, ít nấu ăn, giờ giấc ổn định.',
   'Phòng trọ', 16, '2026-09-01', 1, array['Gác lửng', 'Wifi']::text[],
   null, null, null, null, null, array[]::text[]),
  ('tran.thi.b@tronhanh.demo', 'RoomWanted', 'Cần căn hộ mini có bếp riêng khu Gò Vấp', array['Gò Vấp', 'Quận 12']::text[], 3000000, 4500000, 'Hai vợ chồng mới cưới, cần bếp riêng để tự nấu. Ưu tiên chỗ để được xe máy trong nhà.',
   'Căn hộ mini', 25, '2026-08-20', 2, array['WC riêng', 'Chỗ để xe', 'Máy lạnh']::text[],
   null, null, null, null, null, array[]::text[]),
  ('tran.thi.c@tronhanh.demo', 'RoommateWanted', 'Tìm 1 bạn nữ ở ghép căn hộ 2PN Quận 7', array['Quận 7']::text[], 2500000, 3500000, 'Căn hộ đã có sẵn nội thất, mình ở phòng nhỏ, bạn lấy phòng lớn hơn. Mình đi làm giờ hành chính, sạch sẽ, không hút thuốc.',
   null, null, null, null, array[]::text[],
   'Chung cư Sunrise City, Nguyễn Hữu Thọ', 'Quận 7', 3200000, 1, 'Female', array['Không hút thuốc', 'Giữ vệ sinh chung']::text[]),
  ('tran.thi.d@tronhanh.demo', 'RoomWanted', 'Tìm phòng cho nuôi mèo, khu Quận 10 hoặc Quận 12', array['Quận 10', 'Quận 12']::text[], 2500000, 4000000, 'Mình có một bé mèo đã triệt sản và tiêm phòng đầy đủ, rất ít kêu. Cần chủ nhà đồng ý cho nuôi thú cưng.',
   'Phòng trọ', 20, '2026-09-15', 1, array['Cho nuôi thú cưng', 'WC riêng']::text[],
   null, null, null, null, null, array[]::text[]),
  ('tran.thi.e@tronhanh.demo', 'RoommateWanted', 'Cần 2 bạn ở ghép nhà nguyên căn Thủ Đức', array['Thủ Đức']::text[], 1500000, 2200000, 'Nhà 3 phòng ngủ, hiện có 1 bạn ở. Cần thêm 2 người chia tiền nhà và điện nước. Sân để xe rộng.',
   null, null, null, null, array[]::text[],
   'Đường 12, Trường Thọ, Thủ Đức', 'Thủ Đức', 2000000, 2, 'Any', array['Không tụ tập ồn sau 22h']::text[]),
  ('tran.thi.f@tronhanh.demo', 'RoomWanted', 'Tìm căn hộ dịch vụ Quận 7 cho người đi làm', array['Quận 7', 'Bình Thạnh']::text[], 6000000, 9000000, 'Mình làm ở khu Phú Mỹ Hưng, muốn thuê chỗ có thang máy và bảo vệ. Ưu tiên nơi có dọn phòng định kỳ.',
   'Căn hộ dịch vụ', 35, '2026-08-25', 1, array['Máy lạnh', 'WC riêng', 'Chỗ để xe']::text[],
   null, null, null, null, null, array[]::text[]),
  ('tran.thi.g@tronhanh.demo', 'RoomWanted', 'Sinh viên tìm ký túc xá dưới 1,5 triệu', array['Thủ Đức', 'Quận 10']::text[], 800000, 1500000, 'Mình cần chỗ ở rẻ, ở ghép nhiều người cũng được. Chủ yếu cần chỗ ngủ và bàn học, wifi ổn định là được.',
   'Ký túc xá', 0, '2026-09-05', 1, array['Wifi']::text[],
   null, null, null, null, null, array[]::text[]),
  ('tran.thi.h@tronhanh.demo', 'RoommateWanted', 'Tìm bạn nam ở ghép phòng trọ Bình Thạnh', array['Bình Thạnh']::text[], 1200000, 1800000, 'Phòng 20m2 có gác, mình ở dưới, bạn ở gác. Mình làm ca tối nên ban ngày phòng khá trống.',
   null, null, null, null, array[]::text[],
   'Đinh Bộ Lĩnh, Phường 26, Bình Thạnh', 'Bình Thạnh', 1500000, 1, 'Male', array['Đi làm giờ hành chính']::text[]),
  ('tran.thi.i@tronhanh.demo', 'RoomWanted', 'Cần nhà nguyên căn cho nhóm 4 người đi làm', array['Bình Thạnh', 'Gò Vấp']::text[], 7000000, 10000000, 'Nhóm 4 bạn đi làm, cần nhà ít nhất 2 phòng ngủ và chỗ để 4 xe máy. Ký hợp đồng dài hạn 1 năm.',
   'Nhà nguyên căn', 45, '2026-10-01', 4, array['Chỗ để xe', 'Giờ giấc tự do']::text[],
   null, null, null, null, null, array[]::text[]),
  ('tran.thi.j@tronhanh.demo', 'RoomWanted', 'Tìm phòng giờ giấc tự do, mình đi làm ca đêm', array['Quận 10', 'Bình Thạnh']::text[], 2000000, 3500000, 'Mình làm ca đêm nên về nhà lúc 1–2h sáng, cần nơi không khóa cổng sớm. Ở một mình, không nấu nướng nhiều.',
   'Phòng trọ', 18, '2026-09-10', 1, array['Giờ giấc tự do', 'Máy lạnh']::text[],
   null, null, null, null, null, array[]::text[])
) as d(email, kind, title, districts, price_min, price_max, description,
          property_type, min_area, move_in_date, occupant_count, desired_amenities,
          current_address, district, share_price, needed_count, gender_requirement, requirements)
join auth.users u      on u.email = d.email
join public.profiles p on p.user_id = u.id
